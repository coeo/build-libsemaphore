...
describe('Hash functions', function () {
    var _this = this;
    var hasher = new hashers_1.PoseidonHasher();
    it('poseidon', function () { return __awaiter(_this, void 0, void 0, function () {
        var output;
        return __generator(this, function (_a) {
            output = hasher.hash(null, 1, 2);
            expect(output.toString()).toEqual('2104035019328376391822106787753454168168617545136592089411833517434990977743');
            return [2 /*return*/];
        });
    }); });
});
//# sourceMappingURL=Hashers.test.js.map